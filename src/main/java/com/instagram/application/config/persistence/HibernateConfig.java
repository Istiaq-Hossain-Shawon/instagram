package com.instagram.application.config.persistence;
...
@EnableJpaRepositories("com.instagram.application.repositories")
    ...
    public SessionFactory createAndGetLocalSessionFactoryBean() {
        if (this.sessionFactory == null) {
            try {
                ...
                configuration.addPackage("com.instagram.application.model");
                for (Class<?> clazz : (new Reflections("com.instagram.application.model")).getTypesAnnotatedWith(Entity.class)) {
